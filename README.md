...
Sistem gelişimi 5 ana grup üzerinden yürütülmektedir. 
Her grubun kendi alanındaki hem backend hem frontend görevlerini yapması beklenir. 
Gruplar arası bağımlılıklar (örn: MyUser modeli diğer tüm gruplar için gerekli) sprint planlamasında dikkate alınmalıdır.
